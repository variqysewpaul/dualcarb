...
// ── Textured sachet (uses useTexture hook unconditionally) ────
function TexturedSachetModel({
  mouse,
  textureUrl,
}: {
  mouse: React.MutableRefObject<MouseState>;
  ...
  useSachetAnimation(mouse, groupRef, meshRef, lightRef);
    ...
    <group ref={groupRef}>
      ...
      <Float speed={1.5} rotationIntensity={0.15} floatIntensity={0.8}>
        <mesh ref={meshRef} castShadow>
          ...
          <meshStandardMaterial attach="material-0" color="#0a0a0a" roughness={0.25} metalness={0.85} />
          <meshStandardMaterial attach="material-1" color="#0a0a0a" roughness={0.25} metalness={0.85} />
          <meshStandardMaterial attach="material-2" color="#0a0a0a" roughness={0.25} metalness={0.85} />
          <meshStandardMaterial attach="material-3" color="#0a0a0a" roughness={0.25} metalness={0.85} />
          <meshStandardMaterial attach="material-4" map={texture} roughness={0.3} metalness={0.6} envMapIntensity={2} />
          <meshStandardMaterial attach="material-5" color="#0a0a0a" roughness={0.25} metalness={0.85} />
...
// ── Procedural sachet (no texture, uses 3D text) ─────────────
function ProceduralSachetModel({
  mouse,
}: {
  mouse: React.MutableRefObject<MouseState>;
}) {
  ...
  return (
    <group ref={groupRef}>
      ...
      <Float speed={1.5} rotationIntensity={0.15} floatIntensity={0.8}>
        <mesh ref={meshRef} castShadow>
          <boxGeometry args={[2.8, 4.5, 0.35]} />
          <meshStandardMaterial color="#0a0a0a" roughness={0.25} metalness={0.85} envMapIntensity={3} />
    ...
    >
      ...
      >
        ...
        <Suspense fallback={null}>
          {textureUrl ? (
            <TexturedSachetModel mouse={mouse} textureUrl={textureUrl} />
          ) : (
            <ProceduralSachetModel mouse={mouse} />
          )}
        </Suspense>
